...
import zee.library.common.skin.Skin;
import zee.library.common.skin.SkinUtils;
...
public class SkinActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void load() {
        ...
        viewModel.changeItem(0, music);*/

        LiveDataBus.getInstance().with("playMusic", String.class)
                .observe(this, new Observer<String>() {
                    @Override
                    public void onChanged(String s) {
                        Toast.makeText(SkinActivity.this, "SkinActivity:" + s, Toast.LENGTH_LONG).show();
                    }
                });
    }
